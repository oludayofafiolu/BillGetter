...
var provider_1 = require("../src/GetFromProvider/provider");
var app = express();
...
app.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (request.body["provider"] && request.body["callBackURL"]) {
            provider = new provider_1.GetFromProvider(request.body["provider"], request.body["callBackURL"]);
            result = provider.postToProvider();
        }
